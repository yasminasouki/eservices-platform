...
@section('content')
    <form method="POST" action="{{ route('municipality.password.email') }}">
        @csrf
        ...
        <p class="text-center mb-0 small text-muted">
            ...
            <a href="{{ route('municipality.login') }}" class="text-decoration-none fw-semibold text-primary">{{ __('ui.auth_sign_in_link') }}</a>
        </p>
    </form>
@endsection
